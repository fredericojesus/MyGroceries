...
public abstract class DBManager<T> extends SQLiteOpenHelper {
	...
	protected static final String TABLE_BUYED_LIST = "buyedList";
	...
	protected static final String ITEM_ESSENTIAL = "essential";
	protected static final String ITEM_MINIMUM = "minimum";
	protected static final String ITEM_QUANTITY = "quantity";
	...
	protected static final String BRAND_NEED = "need";
	protected static final String BRAND_FAVOURITE = "favourite";
	...
	// List Buyed column name
	protected static final String BUYED_LIST_ITEM_ID = "fk_item_id";
	...
	// Index Buyed List
	private static final String INDEX_BUYED_LIST_PK = "BUYED_LIST_PK_I";
	private static final String INDEX_BUYED_LIST_ITEM_FK = "BUYED_LIST_ITEM_FK_I";
	...
	private static final String CREATE_TABLE_SHOPPING_LIST = "CREATE TABLE "
			...
			+ "foreign key (" + SHOPPING_LIST_ITEM_ID + ") references " + TABLE_ITEM + " (" + ID + "))";
	...
	// Create Buyed List table
	private static final String CREATE_TABLE_BUYED_LIST = "CREATE TABLE "
			+ TABLE_BUYED_LIST + "(" + ID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " 
			+ BUYED_LIST_ITEM_ID + " INTEGER, "
			+ "foreign key (" + BUYED_LIST_ITEM_ID + ") references " + TABLE_ITEM + " (" + ID + "))";

	// Create Index PK Buyed List
	private static final String CREATE_INDEX_BUYED_LIST_PK = "CREATE INDEX IF NOT EXISTS "
			+ INDEX_BUYED_LIST_PK
			+ " ON "
			+ TABLE_BUYED_LIST
			+ " ("
	...
	// Create Index FK Buyed List Item
	private static final String CREATE_INDEX_BUYED_LIST_ITEM_FK = "CREATE INDEX IF NOT EXISTS "
			+ INDEX_BUYED_LIST_ITEM_FK
			+ " ON "
			+ TABLE_BUYED_LIST
			+ " ("
			+ BUYED_LIST_ITEM_ID + ")";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(CREATE_TABLE_BUYED_LIST);
		...
		db.execSQL(CREATE_INDEX_BUYED_LIST_PK);
		db.execSQL(CREATE_INDEX_BUYED_LIST_ITEM_FK);
	}
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_BUYED_LIST);
		...
		db.execSQL("DROP INDEX IF EXISTS " + INDEX_BUYED_LIST_PK);
		db.execSQL("DROP INDEX IF EXISTS " + INDEX_BUYED_LIST_ITEM_FK);
